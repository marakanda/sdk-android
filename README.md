...
```groovy
dependencies {
    implementation "io.ebuilder.mobile.services:ddc-sdk:2.1.0.334"
}
```

**Note**: The DDC SDK has [dependencies of its own](https://artifacts.ebuilder.io/repository/ebuilder-external-android/io/ebuilder/mobile/services/ddc-sdk/2.1.0.334/ddc-sdk-2.1.0.334.pom). If you run into build or runtime issues because your project depends on an older version of the Android legacy support library, you might want to exclude the one required by DDC: 
